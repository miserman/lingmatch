...
```{r}
meta <- dictionary_meta(dict[3:4], suggest = TRUE)
meta$suggested
```

This can help improve the theoretical coverage of these categories in themselves,
...
texts <- c(
  ...
  although = "The chair sat down at their desk to table the discussion."
)
