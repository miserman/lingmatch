...
```{r, fig.height=5, fig.width=10, fig.alt="a plot comparing weighted and raw work counts"}
...
```{r, fig.height=5, fig.width=10, fig.alt="a plot comparing different weighting methods, holding term constant"}
...
```{r, fig.height=5, fig.width=10, fig.alt="a plot comparing different weighting methods when term and document frequencies are the same"}
...
```{r, fig.height=5, fig.width=10, fig.alt="a plot comparing different weighting methods when term and document frequencies are different"}
# here, counts decrease from 20 to 1, while appearing in 1 to 20 documents,
# so less common terms have higher term frequencies
splot(
  sapply(doc_weights, weight_range, value = "inverted") ~ 1:20,
