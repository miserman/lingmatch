...
```{r, fig.height=4, fig.width=10, fig.alt="a plot of terms within an example smallness-bigness space"}
...
```{r, fig.height=4, fig.width=10, fig.alt="a plot of terms within a real smallness-bigness space"}
...
```{r, fig.height=4, fig.width=10, fig.alt="a plot of terms within a real smallness-bigness space, with fuzzy similarities"}
...
```{r, fig.height=2, fig.width=10, fig.alt="a plot showing the top terms within the first"}
# now we can see the top-loading terms on single dimensions
top_terms(1, lss)
```

```{r, fig.height=2, fig.width=10, fig.alt="a plot showing the top terms within the second"}
top_terms(2, lss)
```

```{r, fig.height=2, fig.width=10, fig.alt="a plot showing the top terms within the third"}
top_terms(3, lss)
```

```{r, fig.height=2, fig.width=10, fig.alt="a plot showing the top terms across the first 5 dimensions"}
# or top-loading terms on aggregated dimensions
top_terms(1:5, lss)
```

```{r, fig.height=2, fig.width=10, fig.alt="a plot showing the top terms across all dimensions"}
...
```{r, fig.height=2.5, fig.width=10, fig.alt="a plot showing the top terms across the 10 most whales like dimensions"}
