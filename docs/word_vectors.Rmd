...
***
# In-sample vectors
The <a href='https://miserman.github.io/lingmatch/#text_analysis' target='_blank' rel='nofollow'>introduction</a> mostly focused on the representation of documents as vectors within a common document-term space. With that same representation, we can focus on the term vectors instead. 
```{r}
library(splot)
library(lingmatch)
