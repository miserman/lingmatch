...
lsm_novels = lingmatch(data, 'novels', type = 'lsm')
...
## Participant ID
Similarity, participants are only uniquely identified by pair ID and speaker ID (though this could just as well be a single column with unique IDs).
```{r}
